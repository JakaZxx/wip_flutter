...
<div class="container-custom">
    ...
    <!-- Filter -->
    <form id="filter-form" method="GET" action="{{ route('borrowing.request.create.student') }}" class="filter-container fade-up" onsubmit="return preserveCartOnFilter(event)">
        ...
        <div id="checkout-modal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="borrow_time" class="form-label">Jam Peminjaman</label>
                    ...
                    <div class="form-group">
                        <label for="return_time" class="form-label">Jam Pengembalian</label>
...
<script>
    ...
    document.getElementById('borrowing-form').addEventListener('submit', function(e) {
        ...
        console.log('Borrow time:', document.getElementById('borrow_time').value);
        console.log('Return date:', document.getElementById('return_date').value);
        console.log('Return time:', document.getElementById('return_time').value);
        console.log('Tujuan:', document.getElementById('tujuan').value);
    });

    // Fungsi untuk preserve cart saat filter
