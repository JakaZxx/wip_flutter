...
<div id="approveModal" class="modal">
    <div class="modal-content">
        ...
        <form id="approveForm" method="POST">
            ...
            <button type="submit" class="approve-btn" style="background-color: #28a745; color: #fff; border: none; padding: 8px 14px; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; transition: background-color 0.3s ease; display: inline-flex; align-items: center; gap: 6px;"><i class="fas fa-check"></i> Setujui Terpilih</button>
        </form>
    </div>
</div>
...
<div id="rejectModal" class="modal">
    <div class="modal-content">
        ...
        <form id="rejectForm" method="POST">
            ...
            <button type="submit" class="reject-btn" style="background-color: #dc3545; color: #fff; border: none; padding: 8px 14px; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; transition: background-color 0.3s ease; display: inline-flex; align-items: center; gap: 6px;"><i class="fas fa-times"></i> Tolak Terpilih</button>
        </form>
    </div>
</div>
...
<div id="returnModal" class="modal">
    <div class="modal-content">
        ...
        <h3>Pilih Barang untuk Dikembalikan</h3>
        <form id="returnForm" method="POST">
            @csrf
            <div id="returnItemsList"></div>
            <button type="submit" class="return-btn" style="background-color: #28a745; color: #fff; border: none; padding: 8px 14px; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; transition: background-color 0.3s ease; display: inline-flex; align-items: center; gap: 6px;"><i class="fas fa-undo"></i> Kembalikan Terpilih</button>
        </form>
    </div>
</div>
...
<script>
    ...
    function openApproveModal(borrowingId) {
        ...
        document.getElementById('approveForm').action = '{{ route("borrowings.approve", ":id") }}'.replace(':id', borrowingId);
    ...
    function openRejectModal(borrowingId) {
        ...
        document.getElementById('rejectForm').action = '{{ route("borrowings.reject", ":id") }}'.replace(':id', borrowingId);
    ...
    function openReturnModal(borrowingId) {
        ...
        document.getElementById('returnForm').action = '{{ route("borrowings.return", ":id") }}'.replace(':id', borrowingId);
...
<div class="container">
    ...
    <!-- Search & Filter -->
    <form method="GET" action="{{ route('officers.borrowings.index') }}" class="filters">
