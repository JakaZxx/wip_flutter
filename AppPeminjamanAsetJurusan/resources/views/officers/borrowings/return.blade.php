...
<div class="return-container">
    <div class="return-card">
        ...
        <form action="{{ route('officers.borrowings.return.item.process', $item->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
        ...
        <a href="{{ route('officers.borrowings.show', $item->borrowing_id) }}" class="back-link">
