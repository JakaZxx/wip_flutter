...
<div class="container mt-5">
    ...
    @endif
    <form action="{{ route('officers.assets.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="code" name="code" required value="{{ old('code') }}">
        </div>
        <div class="mb-3">
        ...
        <a href="{{ route('officers.assets.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
